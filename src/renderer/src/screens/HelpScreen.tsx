  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-5 text-sm text-slate-300">
        ...
        <div className="space-y-2">
          ...
          <ScreenDoc icon="🧰" title="セットアップ">
            ...
            <UL>
              ...
              <li>アプリの更新で対応エンジンバージョンが上がると「<b>エンジンを更新</b>」ボタンが表示されます。更新するとエンジンは丸ごと入れ替わり、導入済みのカスタムノードは自動で再導入されます(新しいモデルによっては更新が必須です)</li>
          ...
          <ScreenDoc icon="🎭" title="MiniMax H3 — 映像と音声を同時生成するオムニモーダル">
            ...
            <UL>
              ...
              <li><b>I2Vの縦横比</b>: モデルは最初のフレームを選択解像度へ引き伸ばすため、縦画像→横動画などは歪みます。「縦横が合わない画像の扱い」で<b>ぼかし背景(推奨)/黒帯/中央クロップ/引き伸ばし</b>を選べます。画像の向きに合わせた解像度(9:16 / 16:9)を選ぶのが最良です</li>
      ...
      <Section id="help-install" title="④ インストールとアンインストール">
        ...
        <UL>
          <li>
            起動時に自動確認するほか、<b>セットアップ画面「⑤ アプリの更新」の「今すぐ更新を確認」</b>でいつでも確認できます。新しいバージョンは<b>バックグラウンドでダウンロード</b>され、通知が表示されます
          </li>
          <li>
            適用はアプリを終了したタイミングで自動的に行われます(生成・書き出しの実行中に勝手に再起動することはありません)。「⑤ アプリの更新」の「今すぐ再起動して更新」ですぐに適用することもできます
          </li>
