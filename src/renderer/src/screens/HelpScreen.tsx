    ...
    <div className="p-6 max-w-4xl mx-auto space-y-5 text-sm text-slate-300">
      ...
      <Section id="help-overview" title="① アプリ概要">
        <p className="text-xs leading-relaxed">
          Movie Creator Studio は、7種類の動画生成AIをローカルPCで実行できるオールインワンの動画制作アプリです。
        ...
        <div className="space-y-2">
          <ScreenDoc icon="🏠" title="ホーム">
            ...
            <UL>
              ...
              <li>「やりたいことから選ぶ」— 目的別の7枚のカードから生成画面へ移動。未導入のモデルは 🔒 表示になり、クリックするとセットアップ画面へ案内します</li>
          ...
          <ScreenDoc icon="🎬" title="生成画面の共通操作(7画面共通)">
            <H>基本の流れ</H>
            <OL>
